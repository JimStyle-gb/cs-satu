...
- печатает build summary и запускает supplier quality gate.

Что не делает:
- не хранит regex-логику AkCent;
- не содержит supplier-specific cleanup поверх adapter-layer;
- не подменяет shared core и writer-слой.
"""
