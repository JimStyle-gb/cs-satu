...
TOP_GROUPS: list[tuple[str, str]] = [
    ("9631596", "Расходные материалы для принтеров и МФУ"),
    ("9631605", "Запчасти и комплектующие для принтеров и МФУ"),
    ("9631614", "Принтеры, МФУ, плоттеры и сканеры"),
    ("9631619", "Проекторы, экраны и интерактивное оборудование"),
    ("9631625", "Оборудование для документов"),
    ("9631633", "Компьютерная техника и мониторы"),
    ("9631641", "ИБП, стабилизаторы и аккумуляторы"),
    ("9631646", "Кабели и аксессуары подключения"),
]

LEAF_GROUPS: list[tuple[str, str, str]] = [
    ("9631597", "9631596", "Картриджи лазерные и тонер-картриджи"),
    ("9631598", "9631596", "Картриджи струйные и чернильные ёмкости"),
    ("9631599", "9631596", "Чернила"),
    ("9631600", "9631596", "Тонеры и девелоперы"),
    ("9631601", "9631596", "Драм-юниты и фотобарабаны"),
    ("9631602", "9631596", "Печатающие головки"),
    ("9631603", "9631596", "Контейнеры для отработки"),
    ("9631604", "9631596", "Прочие расходные материалы"),
    ("9631606", "9631605", "Термоблоки и фьюзеры"),
    ("9631607", "9631605", "Блоки проявки"),
    ("9631608", "9631605", "Узлы и ремни переноса"),
    ("9631609", "9631605", "Ролики подачи и ремкомплекты"),
    ("9631610", "9631605", "Финишеры, лотки и подставки"),
    ("9631611", "9631605", "Сервисные комплекты и наборы"),
    ("9631613", "9631605", "Прочие запчасти и комплектующие"),
    ("9631615", "9631614", "МФУ"),
    ("9631616", "9631614", "Принтеры"),
    ("9631617", "9631614", "Плоттеры и широкоформатные принтеры"),
    ("9631618", "9631614", "Сканеры"),
    ("9631620", "9631619", "Проекторы"),
    ("9631621", "9631619", "Экраны для проекторов"),
    ("9631622", "9631619", "Интерактивные панели"),
    ("9631623", "9631619", "Интерактивные доски"),
    ("9631624", "9631619", "Аксессуары для интерактивного оборудования"),
    ("9631626", "9631625", "Ламинаторы"),
    ("9631630", "9631625", "Плёнка для ламинирования"),
    ("9631631", "9631625", "Переплетчики"),
    ("9631632", "9631625", "Шредеры"),
    ("9631634", "9631633", "Ноутбуки"),
    ("9631635", "9631633", "Мониторы"),
    ("9631637", "9631633", "Моноблоки"),
    ("9631638", "9631633", "Настольные ПК и barebone"),
    ("9631639", "9631633", "Рабочие станции"),
    ("9631640", "9631633", "Комплектующие ПК"),
    ("9631642", "9631641", "Источники бесперебойного питания"),
    ("9631643", "9631641", "Стабилизаторы напряжения"),
    ("9631644", "9631641", "Аккумуляторы и батарейные блоки"),
    ("9631645", "9631641", "Аксессуары и модули для ИБП"),
    ("9631647", "9631646", "Кабели"),
    ("9631648", "9631646", "Аксессуары подключения"),
]
